...
```
All report files were saved in the folder [quast_out](https://github.com/noonecanhearyou/analysis-of-genomic-and-transcriptomic-data-itmo-2026/tree/main/task_1/quast_out)
...
```
Next, the ViralVerify tool was used to clearly distinguish viral contigs from other possible contigs:
### Step 4 - BLAST
