...
```
This command parses the annotated VCF file and extracts relevant fields from the ANN annotation generated by SnpEff. The resulting file [table_full.csv](https://github.com/noonecanhearyou/analysis-of-genomic-and-transcriptomic-data-itmo-2026/blob/main/task_2/table_full.csv) contains a structured summary of variants suitable for downstream analysis. 

The identified mutations were analyzed to determine their potential impact on protein function and their possible role in antibiotic resistance:

1. ftsI (missense_variant, MODERATE, Ala544Gly)
    The ftsI gene encodes a penicillin-binding protein (PBP), which is the primary target of β-lactam antibiotics such as ampicillin.
    The Ala544Gly substitution may alter the structure of the protein and reduce the binding affinity of the antibiotic.
    This mutation is likely to directly contribute to antibiotic resistance by preventing effective inhibition of cell wall synthesis.

2. acrB (missense_variant, MODERATE, Gln569Leu)
    The acrB gene encodes a component of the AcrAB-TolC efflux pump system.
    This system actively exports a wide range of toxic compounds, including antibiotics, out of the bacterial cell.
    The Gln569Leu mutation may affect the efficiency or regulation of the efflux pump, potentially increasing antibiotic export and contributing to resistance.

3. envZ (missense_variant, MODERATE, Val241Gly)
    The envZ gene encodes a sensor kinase that is part of the EnvZ/OmpR two-component regulatory system.
    This system controls the expression of outer membrane porins.
    The Val241Gly mutation may alter signal transduction and lead to changes in porin expression, potentially reducing antibiotic uptake into the cell.